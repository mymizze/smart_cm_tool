...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    defaultMessage: "이 값은 유효하지 않습니다",
    type: {
      email: "이 항목은 유효한 Email만 가능합니다",
      url: "이 항목은 유효한 URL만 가능합니다",
      number: "이 항목은 유효한 숫자만 가능합니다",
      integer: "이 항목은 유효한 정수만 가능합니다",
      digits: "이 항목은 숫자만 가능합니다",
      alphanum: "이 항목은 문자와 숫자만 입력이 가능합니다"
    },
    notblank: "이 항목은 빈 값을 넣을 수 없습니다",
    required: "필수항목 입니다",
    pattern: "이 값은 유효하지 않습니다",
    min: "적어도 %s자 이상 입력 해주세요",
    max: "%s자를 넘을 수 없습니다",
    range: "%s ~ %s 범위의 값을 입력 해주세요",
    minlength: "최소 %s자 이상 입력 해주세요",
    maxlength: "%s자를 넘을 수 없습니다",
    length: "%s자 이상 %s자 이하로 입력 해주세요",
    mincheck: "적어도 %s개를 선택해야 합니다",
    maxcheck: "최대 %s개 이상 선택할 수 없습니다",
    check: "%s ~ %s 범위 내에서 선택해주세요",
    equalto: "이 값은 서로 같아야 합니다"
  });
